// File:    CAllocateNoteDetailMgr.cs
// Author:  甘孝俭
...
// Purpose: Definition of Class CAllocateNoteDetailMgr
...
{
    public class CAllocateNoteDetailMgr : CBaseObjectMgr
    {

        public CAllocateNoteDetailMgr()
        {
