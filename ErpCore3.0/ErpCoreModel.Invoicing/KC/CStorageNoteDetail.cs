...
// Purpose: Definition of Class CStorageNoteDetail
...
namespace ErpCoreModel.Invoicing
{
    ...
    public class CStorageNoteDetail : CBaseObject
    {

        public CStorageNoteDetail()
        {
            TbCode = "KC_StorageNoteDetail";
            ClassName = "ErpCoreModel.Invoicing.CStorageNoteDetail";
        ...
        public Guid KC_StorageNote_id
        {
            get
            {
                if (m_arrNewVal.ContainsKey("kc_storagenote_id"))
                    return m_arrNewVal["kc_storagenote_id"].GuidVal;
                else
                    return Guid.Empty;
            }
            set
            {        
                if (m_arrNewVal.ContainsKey("kc_storagenote_id"))
                    m_arrNewVal["kc_storagenote_id"].GuidVal = value;
                else
                {
                    CValue val = new CValue();
                    val.GuidVal = value;
                    m_arrNewVal.Add("kc_storagenote_id", val);
                }
            }
        }
    }
