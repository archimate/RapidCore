...
// Purpose: Definition of Class CDeliveryNoteDetail
...
namespace ErpCoreModel.Invoicing
{
    ...
    public class CDeliveryNoteDetail : CBaseObject
    {

        public CDeliveryNoteDetail()
        {
            TbCode = "KC_DeliveryNoteDetail";
            ClassName = "ErpCoreModel.Invoicing.CDeliveryNoteDetail";
        ...
        public Guid KC_DeliveryNote_id
        {
            get
            {
                if (m_arrNewVal.ContainsKey("kc_deliverynote_id"))
                    return m_arrNewVal["kc_deliverynote_id"].GuidVal;
                else
                    return Guid.Empty;
            }
            set
            {        
                if (m_arrNewVal.ContainsKey("kc_deliverynote_id"))
                    m_arrNewVal["kc_deliverynote_id"].GuidVal = value;
                else
                {
                    CValue val = new CValue();
                    val.GuidVal = value;
                    m_arrNewVal.Add("kc_deliverynote_id", val);
                }
            }
        }
    }
