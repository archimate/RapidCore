...
// Purpose: Definition of Class CPriceNoteDetail
...
namespace ErpCoreModel.Invoicing
{
    ...
    public class CPriceNoteDetail : CBaseObject
    {

        public CPriceNoteDetail()
        {
        ...
        public Guid XS_PriceNote_id
        {
            get
            {
                if (m_arrNewVal.ContainsKey("xs_pricenote_id"))
                    return m_arrNewVal["xs_pricenote_id"].GuidVal;
                else
                    return Guid.Empty;
            }
            set
            {        
                if (m_arrNewVal.ContainsKey("xs_pricenote_id"))
                    m_arrNewVal["xs_pricenote_id"].GuidVal = value;
                else
                {
                    CValue val = new CValue();
                    val.GuidVal = value;
                    m_arrNewVal.Add("xs_pricenote_id", val);
                }
            }
        }
