// File:    CPurchaseReturnNoteDetail.cs
// Author:  甘孝俭
...
// Purpose: Definition of Class CPurchaseReturnNoteDetail
...
namespace ErpCoreModel.Invoicing
{
    ...
    public class CPurchaseReturnNoteDetail : CBaseObject
    {

        public CPurchaseReturnNoteDetail()
        {
            TbCode = "CG_PurchaseReturnNoteDetail";
            ClassName = "ErpCoreModel.Invoicing.CPurchaseReturnNoteDetail";
        ...
        public Guid CG_PurchaseReturnNote_id
        {
            get
            {
                if (m_arrNewVal.ContainsKey("cg_purchasereturnnote_id"))
                    return m_arrNewVal["cg_purchasereturnnote_id"].GuidVal;
                else
                    return Guid.Empty;
            }
            set
            {        
                if (m_arrNewVal.ContainsKey("cg_purchasereturnnote_id"))
                    m_arrNewVal["cg_purchasereturnnote_id"].GuidVal = value;
                else
                {
                    CValue val = new CValue();
                    val.GuidVal = value;
                    m_arrNewVal.Add("cg_purchasereturnnote_id", val);
                }
            }
        }
    }
