...
// Purpose: Definition of Class CPurchaseNoteDetail
...
namespace ErpCoreModel.Invoicing
{
    ...
    public class CPurchaseNoteDetail : CBaseObject
    {

        public CPurchaseNoteDetail()
        {
            TbCode = "CG_PurchaseNoteDetail";
            ClassName = "ErpCoreModel.Invoicing.CPurchaseNoteDetail";
        ...
        public Guid CG_PurchaseNote_id
        {
            get
            {
                if (m_arrNewVal.ContainsKey("cg_purchasenote_id"))
                    return m_arrNewVal["cg_purchasenote_id"].GuidVal;
                else
                    return Guid.Empty;
            }
            set
            {        
                if (m_arrNewVal.ContainsKey("cg_purchasenote_id"))
                    m_arrNewVal["cg_purchasenote_id"].GuidVal = value;
                else
                {
                    CValue val = new CValue();
                    val.GuidVal = value;
                    m_arrNewVal.Add("cg_purchasenote_id", val);
                }
            }
        }
    }
