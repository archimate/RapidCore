...
// Purpose: Definition of Class CPurchaseNote
...
namespace ErpCoreModel.Invoicing
{
    ...
    public class CPurchaseNote : CBaseObject
    {

        public CPurchaseNote()
        {
        ...
        public CPurchaseNoteDetailMgr PurchaseNoteDetailMgr
        {
            get
            {
                return (CPurchaseNoteDetailMgr)this.GetSubObjectMgr("CG_PurchaseNoteDetail", typeof(CPurchaseNoteDetailMgr));
            }
            set
            {
                this.SetSubObjectMgr("CG_PurchaseNoteDetail", value);
            }
        }
    }
}