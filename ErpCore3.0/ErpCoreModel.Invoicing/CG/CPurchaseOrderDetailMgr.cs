// File:    CPurchaseOrderDetailMgr.cs
// Author:  甘孝俭
...
// Purpose: Definition of Class CPurchaseOrderDetailMgr
...
{
    public class CPurchaseOrderDetailMgr : CBaseObjectMgr
    {

        public CPurchaseOrderDetailMgr()
        {
