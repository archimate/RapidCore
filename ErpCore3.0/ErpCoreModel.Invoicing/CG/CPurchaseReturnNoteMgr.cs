// File:    CPurchaseReturnNoteMgr.cs
// Author:  甘孝俭
...
// Purpose: Definition of Class CPurchaseReturnNoteMgr
...
{
    public class CPurchaseReturnNoteMgr : CBaseObjectMgr
    {

        public CPurchaseReturnNoteMgr()
        {
