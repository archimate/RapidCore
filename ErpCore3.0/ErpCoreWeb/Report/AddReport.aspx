<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddReport.aspx.cs" Inherits="Report_AddReport" %>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            grid = $("#gridTable").ligerGrid({
                ...
                url: 'AddReport.aspx?Action=GetData&B_Company_id=<%=Request["B_Company_id"] %>',
                dataAction: 'server',
                usePager: false,
                enabledEdit: true,
                rownumbers: true,
...
<body style="padding:6px; overflow:hidden;">
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="cbCatalog" type="text" id="cbCatalog"  />
            <input name="hidCatalog" type="hidden" id="hidCatalog"  /></td>
   ...
   <div id="gridTable" style="margin:0; padding:0"></div>
    ...
    <table>    
        ...
        <tr>
            ...
            <table>
            <tr><td>
            <textarea cols="100" rows="4" class="l-textarea" id="Filter" style="width:450px" ></textarea>
            </td></tr>
            <tr><td>
                <table><tr><td>
