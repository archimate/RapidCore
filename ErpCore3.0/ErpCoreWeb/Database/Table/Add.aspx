<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="Database_Table_Add" %>
...
<head>
    ...
    <script type="text/javascript">
        var colTypeData = [{ ColType: '字符型', text: '字符型' },
        { ColType: '整型', text: '整型' },
...
<body style="padding:6px; ">
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        <tr>
            ...
            <td align="left" class="l-table-edit-td"><input name="txtTbName" type="text" id="txtTbName" ltype="text" validate="{required:true,maxlength:50}" /></td>
            
            <td align="right" class="l-table-edit-td">编码:</td>
            <td align="left" class="l-table-edit-td"><input name="txtTbCode" type="text" id="txtTbCode" ltype="text" validate="{required:true,maxlength:50}" /></td>
            
            <td align="right" class="l-table-edit-td"><input id="ckIsSystem" type="checkbox" />系统表</td>
        </tr>
  </table>
