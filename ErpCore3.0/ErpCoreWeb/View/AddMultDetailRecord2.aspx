<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddMultDetailRecord2.aspx.cs" Inherits="View_AddMultDetailRecord2" %>
        ...
        function onCancel() {
            $.post(
                ...
                vdid:'<%=Request["vdid"] %>',
                 ...
                 function(data) {
                     if (data == "" || data == null) {
                         parent.onCancelAddMultDetailRecord2();
                         return true;
                     }
                     else {
