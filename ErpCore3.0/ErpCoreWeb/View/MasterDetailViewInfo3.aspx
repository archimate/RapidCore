<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MasterDetailViewInfo3.aspx.cs" Inherits="View_MasterDetailViewInfo3" %>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            grid = $("#gridTable").ligerGrid({
                ...
                url: 'MasterDetailViewInfo3.aspx?Action=GetData&id=<%=Request["id"] %>&catalog_id=<%=Request["catalog_id"] %> ',
                dataAction: 'server',
                usePager: false,
                enabledEdit: true,
                width: '100%', height: '80%',
        ...
        $(function() {
            grid2 = $("#gridDetail").ligerGrid({
                ...
                url: 'MasterDetailViewInfo3.aspx?Action=GetDetail&id=<%=Request["id"] %>&catalog_id=<%=Request["catalog_id"] %> ',
                dataAction: 'server',
                usePager: false,
                enabledEdit: true,
                width: '100%', height: '80%',
        ...
        function btPrev_onclick() {
            window.location.href = 'MasterDetailViewInfo2.aspx?id=<%=Request["id"] %>&catalog_id=<%=Request["catalog_id"] %> ';
        }
        ...
        function btNext_onclick() {
            ...
            $.post(
                'MasterDetailViewInfo3.aspx',
                {
                 ...
                 function(data) {
                     if (data == "" || data == null) {
                         window.location.href = 'MasterDetailViewInfo4.aspx?id=<%=Request["id"] %>&catalog_id=<%=Request["catalog_id"] %> ';
                         return true;
                     }
                     else {
...
<body style="padding:6px; overflow:hidden;"> 
  ...
  <div id="toptoolbar"></div> 
    ...
    <div>从表：<input id="txtTbName2" name="txtTbName2" value="<%=m_DTable.Name %>" disabled="disabled" /></div>
