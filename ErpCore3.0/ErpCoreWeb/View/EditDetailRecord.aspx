<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditDetailRecord.aspx.cs" Inherits="View_EditDetailRecord" %>
        ...
        function onCancel() {
            $.post(
                ...
                id:'<%=Request["id"] %>',
                 ...
                 function(data) {
                     if (data == "" || data == null) {
                         parent.onCancelEditDetailRecord();
                         return true;
                     }
                     else {
