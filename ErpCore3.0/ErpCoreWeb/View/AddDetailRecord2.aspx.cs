...
public partial class View_AddDetailRecord2 : System.Web.UI.Page
{
    ...
    void PostData()
    {
        ...
        m_BaseObjectMgr.AddNew(BaseObject);
        ...
        Response.Write("<script>parent.parent.onOkAddDetailRecord2();</script>");
    }
    //验证数据
    bool ValidateData()
    {
