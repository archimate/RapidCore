...
public partial class View_AddMultMasterDetailViewRecord : System.Web.UI.Page
{
    ...
    void PostData()
    {
        ...
        CBaseObject BaseObject = (CBaseObject)Session["AddMultMasterDetailViewRecord"];
        ...
        Response.Write("<script>parent.parent.onOkAddMultMasterDetailViewRecord();</script>");
    }
