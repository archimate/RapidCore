<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddMasterDetailViewRecord.aspx.cs" Inherits="View_AddMasterDetailViewRecord" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function onCancel() {
            $.post(
                'AddMasterDetailViewRecord.aspx',
                {
                vid:'<%=Request["vid"] %>',
        ...
        function onAdd() {
            $.ligerDialog.open({ title: '新建', url: 'AddDetailRecord.aspx?vid=<%=Request["vid"] %>', name: 'winAddDetailRec', height: winHeight, width: winWidth, showMax: true, showToggle: true,  isResize: true, modal: false, slide: false, 
            buttons: [
        ...
        function onOkAddDetailRecord(){
            grid.loadData(true);
            $.ligerDialog.close();
        }
        function onCancelAddDetailRecord(){
            grid.loadData(true);
            $.ligerDialog.close();
        }
        function onEdit() {
            ...
            $.ligerDialog.open({ title: '修改', url: 'EditDetailRecord.aspx?vid=<%=Request["vid"] %>&id=' + row.id, name: 'winEditDetailRec', height: winHeight, width: winWidth, showMax: true, showToggle: true,  isResize: true, modal: false, slide: false, 
            buttons: [
                { text: '确定', onclick: function(item, dialog) {
        ...
        function onOkEditDetailRecord(){
            grid.loadData(true);
            $.ligerDialog.close();
        }
        function onCancelEditDetailRecord(){
            grid.loadData(true);
            $.ligerDialog.close();
        }
        ...
        $(function ()
        {
            ...
            columns: [
                ...
                url: 'AddMasterDetailViewRecord.aspx?Action=GetDetail&vid=<%=Request["vid"] %>&ParentId=<%=Request["ParentId"] %>',
                dataAction: 'server', 
                usePager: false,
