<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddMultMasterDetailViewRecord.aspx.cs" Inherits="View_AddMultMasterDetailViewRecord" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function onCancel() {
            $.post(
                'AddMultMasterDetailViewRecord.aspx',
                {
                vid:'<%=Request["vid"] %>',
                ParentId: '<%=Request["ParentId"] %>',
                 ...
                 function(data) {
                     if (data == "" || data == null) {
                         parent.onCancelAddMultMasterDetailViewRecord();
                         return true;
                     }
                     else {
        ...
        {                
            ...
            <%foreach(CBaseObject obj in m_View.ViewDetailMgr.GetList())
            {
                ...
                %>
                f_addTab('<%=vd.Id %>','<%=vd.Name %>','MultDetailListRecord.aspx?vid=<%=Request["vid"] %>&vdid=<%=vd.Id %>');
                <%
            }
             %>
        });
