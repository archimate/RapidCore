<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditDetailRecord2.aspx.cs" Inherits="View_EditDetailRecord2" %>
        ...
        function onCancel() {
            $.post(
                ...
                id:'<%=Request["id"] %>',
                 ...
                 function(data) {
                     if (data == "" || data == null) {
                         parent.onCancelEditDetailRecord2();
                         return true;
                     }
                     else {
