...
public partial class View_MultMasterDetailViewInfo3 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (Request.Params["Action"] == "PostDetailData")
        {
            PostDetailData();
            Response.End();
        }
    ...
    void Cancel()
    {
        Session["MultNewMasterDetailView"] = null;
    }
}
