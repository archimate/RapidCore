<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MultMasterDetailViewInfo2.aspx.cs" Inherits="View_MultMasterDetailViewInfo2" %>
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" style="height:50px">
            <tr>
                <td align="left">
                    &nbsp;从表：</td>
                <td align="left">
                    &nbsp;<asp:DropDownList ID="cbDetailTable" runat="server"  
                        Width="142px" onselectedindexchanged="cbDetailTable_SelectedIndexChanged" 
                        AutoPostBack="True">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td align="left">
                    <asp:CheckBoxList ID="listDetailColumn" runat="server" Height="164px" 
                        Width="152px" 
                        onselectedindexchanged="listDetailColumn_SelectedIndexChanged" AutoPostBack="True">
                    </asp:CheckBoxList>
                </td>
            </tr>
