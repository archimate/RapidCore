...
public partial class View_EditMasterDetailViewRecord : System.Web.UI.Page
{
    CUser m_User = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["EditMasterDetailViewRecord"] != null)
        {
            ...
            if(objP.Id.ToString()!= id)
                Session["EditMasterDetailViewRecord"] =null;
        }
        ...
        if (Session["EditMasterDetailViewRecord"] == null)
        {
            ...
            arrP.Add(obj.Id, obj);
            Session["EditMasterDetailViewRecord"] = arrP;
        }

        SortedList<Guid, CBaseObject> arrP2 = (SortedList<Guid, CBaseObject>)Session["EditMasterDetailViewRecord"];
        m_BaseObject = arrP2.Values[0];
        //保存到编辑对象
    ...
    void PostData()
    {
        ...
        Response.Write("<script>parent.parent.onOkEditMasterDetailViewRecord();</script>");
    }
    //验证数据
    bool ValidateData()
    {
