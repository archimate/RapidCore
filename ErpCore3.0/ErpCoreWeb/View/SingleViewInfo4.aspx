<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SingleViewInfo4.aspx.cs" Inherits="View_SingleViewInfo4" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function btPrev_onclick() {
            window.location.href = 'SingleViewInfo3.aspx?id=<%=Request["id"] %>&catalog_id=<%=Request["catalog_id"] %> ';
        }
    ...
    <script type="text/javascript">
        ...
        $(function ()
        {
            ...
            columns: [
                ...
                url: 'SingleViewInfo4.aspx?Action=GetData&id=<%=Request["id"] %>&catalog_id=<%=Request["catalog_id"] %>',
                dataAction: 'server',
                usePager: false,
                width: '100%', height: '80%',
