<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddDetailRecord2.aspx.cs" Inherits="View_AddDetailRecord2" %>
        ...
        function onCancel() {
            $.post(
                ...
                vid:'<%=Request["vid"] %>',
                 ...
                 function(data) {
                     if (data == "" || data == null) {
                         parent.onCancelAddDetailRecord2();
                         return true;
                     }
                     else {
