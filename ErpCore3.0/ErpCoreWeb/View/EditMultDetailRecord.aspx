<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditMultDetailRecord.aspx.cs" Inherits="View_EditMultDetailRecord" %>
        ...
        function onCancel() {
            $.post(
                ...
                id:'<%=Request["id"] %>',
                 ...
                 function(data) {
                     if (data == "" || data == null) {
                         parent.onCancelEditMultDetailRecord();
                         return true;
                     }
                     else {
