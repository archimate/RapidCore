<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MasterDetailViewInfo1.aspx.cs" Inherits="View_MasterDetailViewInfo1" %>
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" style="height:50px">
            ...
            <tr>
                <td align="left">
                    &nbsp;从表：</td>
                <td align="left">
                    &nbsp;<asp:DropDownList ID="cbDetailTable" runat="server" AutoPostBack="True" 
                        onselectedindexchanged="cbDetailTable_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td align="left">
                    &nbsp;外键关联：</td>
                <td align="left">
                    &nbsp;<asp:DropDownList ID="cbPrimaryKey" runat="server">
                    </asp:DropDownList>——
                    <asp:DropDownList ID="cbForeignKey" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
