<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditMultDetailRecord2.aspx.cs" Inherits="View_EditMultDetailRecord2" %>
        ...
        function onCancel() {
            $.post(
                ...
                id:'<%=Request["id"] %>',
                 ...
                 function(data) {
                     if (data == "" || data == null) {
                         parent.onCancelEditMultDetailRecord2();
                         return true;
                     }
                     else {
