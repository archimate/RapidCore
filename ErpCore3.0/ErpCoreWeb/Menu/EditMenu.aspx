<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditMenu.aspx.cs" Inherits="Menu_EditMenu" %>
...
<body  style="padding:20px">
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        ...
        <tr>
            ...
            <td align="left" class="l-table-edit-td">
            <input name="txtOpenwinWidth" type="text" id="txtOpenwinWidth" ltype="text"  runat="server"  />(宽)<br />
            <input name="txtOpenwinHeight" type="text" id="txtOpenwinHeight" ltype="text"  runat="server"  />(高)
            </td>
        </tr>
  </table>
