<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Window_Edit" %>
<%@ Import Namespace="ErpCoreModel" %>
<%@ Import Namespace="ErpCoreModel.Base" %>
<%@ Import Namespace="ErpCoreModel.Framework" %>
<%@ Import Namespace="System.Collections.Generic" %>
<%@ Register TagPrefix="uc1" TagName="WindowRecordCtrl" Src="../CommonCtrl/WindowRecordCtrl.ascx" %>
...
<body style="padding:10px">
    ...
    <div >
        <uc1:WindowRecordCtrl ID="recordCtrl" runat="server" />
    </div>
    </form>
</body>
</html>
