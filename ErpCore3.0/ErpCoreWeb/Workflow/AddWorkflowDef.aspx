<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddWorkflowDef.aspx.cs" Inherits="Workflow_AddWorkflowDef" %>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            grid = $("#gridActives").ligerGrid({
                ...
                url: 'AddWorkflowDef.aspx?Action=GetActivesData&B_Company_id=<%=Request["B_Company_id"] %>',
                dataAction: 'server',
                usePager: false,
        ...
        function LoadGridLink(ActivesId) {
            var url = "AddWorkflowDef.aspx?Action=GetLinkData&ActivesId=" + ActivesId + '&B_Company_id=<%=Request["B_Company_id"] %>';
            grid2.set({ url: url});
            //grid2.loadData();
        }
        ...
        function onSelectCatalog() {
            $.ligerDialog.open({ title: '选择目录', name: 'catalogselector', width: 400, height: 350, url: 'SelectCatalog.aspx?B_Company_id=<%=Request["B_Company_id"] %>', buttons: [
...
<body style="padding:6px; overflow:hidden;">
    ...
    <table cellpadding="0" cellspacing="0" class="l-table-edit" >
        <tr>
            ...
            <input name="hidCatalog" type="hidden" id="hidCatalog" value="<%=m_guidCatalogId %>" /></td>
