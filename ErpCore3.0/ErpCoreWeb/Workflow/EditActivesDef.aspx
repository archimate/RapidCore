<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditActivesDef.aspx.cs" Inherits="Workflow_EditActivesDef" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function ()
        {
            var cbAType = $("#AType").ligerComboBox({
    ...
    <div>
        ...
        <% 
            ...
            foreach (CBaseObject obj in lstCol)
            {
                ...
                {
                    %><input name="<%=col.Code %>" type="hidden" id="<%=col.Code %>" value="<%=m_BaseObject.GetColValue(col) %>"/><%
                    continue;
                }
        ...
        %>
            <tr>
                ...
                <%}
                  ...
                  { %>
                  <textarea cols="100" rows="4" class="l-textarea" id="<%=col.Code %>" style="width:400px" ><%=m_BaseObject.GetColValue(col) %></textarea>
                <%}
                  else if (col.ColType == ColumnType.int_type)
                  { %>
                  <input name="<%=col.Code %>" type="text" id="<%=col.Code %>" value="<%=m_BaseObject.GetColValue(col) %>" ltype='spinner' ligerui="{type:'int'}" class="required" validate="{digits:true}" />
                  <%}
