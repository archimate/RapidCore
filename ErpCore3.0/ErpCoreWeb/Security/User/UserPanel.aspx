<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserPanel.aspx.cs" Inherits="Security_User_UserPanel" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function onAdd() {
            $.ligerDialog.open({ title: '新建', url: 'AddUser.aspx?B_Company_id=<%=Request["B_Company_id"] %>', name: 'winAddRec', height: 460, width: 600, showMax: true, showToggle: true,  isResize: true, modal: false, slide: false, 
                buttons: [
        ...
        function onEdit() {
            ...
            $.ligerDialog.open({ title: '修改', url: 'EditUser.aspx?id=' + row.id + '&B_Company_id=<%=Request["B_Company_id"] %>', name: 'winEditRec', height: 460, width: 600, showMax: true, showToggle: true, isResize: true, modal: false, slide: false, 
            buttons: [
                { text: '确定', onclick: function(item, dialog) {
    ...
    <script type="text/javascript">
        ...
        $(function ()
        {
            ...
            columns: [
                ...
                url: 'UserPanel.aspx?Action=GetData&B_Company_id=<%=Request["B_Company_id"] %>',
