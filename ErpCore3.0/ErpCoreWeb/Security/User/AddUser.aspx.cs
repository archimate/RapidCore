...
public partial class Security_User_AddUser : System.Web.UI.Page
{
    ...
    void PostData()
    {
        ...
        if (!Global.GetCtx(Session["TopCompany"].ToString()).UserMgr.AddNew(BaseObject, true))
        {
            Response.Write("添加失败！");
            return ;
        }
