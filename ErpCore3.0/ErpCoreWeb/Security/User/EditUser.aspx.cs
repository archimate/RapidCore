...
public partial class Security_User_EditUser : System.Web.UI.Page
{
    public CTable m_Table = null;
    public CUser m_BaseObject = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        m_BaseObject =(CUser)Global.GetCtx(Session["TopCompany"].ToString()).UserMgr.Find(new Guid(id));
    ...
    void PostData()
    {
        ...
        if (!Global.GetCtx(Session["TopCompany"].ToString()).UserMgr.Update(m_BaseObject, true))
        {
            Response.Write("修改失败！");
            return ;
        }
