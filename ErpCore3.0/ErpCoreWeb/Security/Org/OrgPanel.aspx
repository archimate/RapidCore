<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrgPanel.aspx.cs" Inherits="Security_Org_OrgPanel" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function onAdd() {
            $.ligerDialog.open({ title: '新建', url: 'AddOrg.aspx?B_Company_id=<%=Request["B_Company_id"] %>', name: 'winAddRec', height: 200, width: 300, showMax: true, showToggle: true,  isResize: true, modal: false, slide: false, 
            buttons: [
        ...
        function onEdit() {
            ...
            $.ligerDialog.open({ title: '修改', url: 'EditOrg.aspx?id=' + row.id + '&B_Company_id=<%=Request["B_Company_id"] %>', name: 'winEditRec', height: 200, width: 300, showMax: true, showToggle: true,  isResize: true, modal: false, slide: false, 
                buttons: [
                { text: '确定', onclick: function(item, dialog) {
    ...
    <script type="text/javascript">
        ...
        $(function ()
        {
            ...
            columns: [
                ...
                url: 'OrgPanel.aspx?Action=GetData&B_Company_id=<%=Request["B_Company_id"] %>',
