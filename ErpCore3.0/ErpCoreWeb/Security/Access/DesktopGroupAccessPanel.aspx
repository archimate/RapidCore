<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DesktopGroupAccessPanel.aspx.cs" Inherits="Security_Access_DesktopGroupAccessPanel" %>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            grid = $("#gridTable").ligerGrid({
                ...
                url: 'DesktopGroupAccessPanel.aspx?Action=GetData&B_Company_id=<%=Request["B_Company_id"] %>',
                dataAction: 'server',
                usePager: false,
                enabledEdit: true,
                rownumbers: true,
        ...
        function onSelectUidOK(item, dialog) {
            ...
            if (document.getElementById("cbUType").selectedIndex == 2)
                utype = "1";
            var url = 'DesktopGroupAccessPanel.aspx?Action=GetData&B_Company_id=<%=Request["B_Company_id"] %>&UType=' + utype + '&Uid=' + data.id;
            grid.set({ url: url });
            grid.loadData();
