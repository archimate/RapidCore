<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Variable.aspx.cs" Inherits="Common_Variable" %>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            grid = $("#gridTable").ligerGrid({
                ...
                { display: '描述', name: 'Desp', align: 'left', width: 200 }
                ],
                url: 'Variable.aspx?Action=GetData',
                dataAction: 'server',
                usePager: false,
                width: '100%', height: '80%'
            });
