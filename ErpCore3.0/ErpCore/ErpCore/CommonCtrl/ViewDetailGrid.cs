...
{
    public partial class ViewDetailGrid : UserControl
    {
        string captionText = "";
        ...
        {
            get { return viewDetail; }
            set
            {
                viewDetail = value;
                //判断视图权限
                if (viewDetail != null)
                    m_ViewAccessType = Program.User.GetViewAccess(viewDetail.UI_View_id);
        ...
        {
            ViewDetailRecord frm = new ViewDetailRecord(BaseObjectMgr, null);
            frm.ViewDetail = ViewDetail;
        ...
        private void tbtEdit_Click(object sender, EventArgs e)
        {
            ...
            ViewDetailRecord frm = new ViewDetailRecord(BaseObjectMgr, obj);
            frm.ViewDetail = ViewDetail;
            frm.BaseObject = obj;
            if (frm.ShowDialog() != DialogResult.OK)
                return;
