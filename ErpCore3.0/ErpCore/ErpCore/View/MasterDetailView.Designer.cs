namespace ErpCore.View
{
    partial class MasterDetailView
    {
        ...
        {
            this.viewGrid = new ErpCore.CommonCtrl.MasterDetailViewGrid();
            this.SuspendLayout();
            // 
            // viewGrid
            // 
            ...
            this.Text = "主从表视图";
            this.Load += new System.EventHandler(this.MasterDetailView_Load);
        ...
        private ErpCore.CommonCtrl.MasterDetailViewGrid viewGrid;
