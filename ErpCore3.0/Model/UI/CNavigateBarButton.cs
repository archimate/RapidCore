...
// Purpose: Definition of Class CNavigateBarButton
using System;
...
{
    public class CNavigateBarButton : CBaseObject
    {
        public CNavigateBarButton()
        {
            TbCode = "UI_NavigateBarButton";
            ClassName = "ErpCoreModel.UI.CNavigateBarButton";

            Name = "";
            UI_NavigateBar_id = Guid.Empty;
            Icon = null;
        ...
        public Guid UI_NavigateBar_id
        {
            get
            {
                if (m_arrNewVal.ContainsKey("ui_navigatebar_id"))
                    return m_arrNewVal["ui_navigatebar_id"].GuidVal;
                else
                    return Guid.Empty;
            }
            set
            {
                if (m_arrNewVal.ContainsKey("ui_navigatebar_id"))
                    m_arrNewVal["ui_navigatebar_id"].GuidVal = value;
                else
                {
                    CValue val = new CValue();
                    val.GuidVal = value;
                    m_arrNewVal.Add("ui_navigatebar_id", val);
                }
            }
        }
        public object Icon
