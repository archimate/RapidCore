...
// Purpose: Definition of Class CTButtonInFormControl
...
namespace ErpCoreModel.UI
{
    ...
    public class CTButtonInFormControl : CBaseObject
    {

        public CTButtonInFormControl()
        {
