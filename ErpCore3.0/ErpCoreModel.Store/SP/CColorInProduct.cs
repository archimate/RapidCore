...
// Purpose: Definition of Class CColorInProduct
...
namespace ErpCoreModel.Store
{
    ...
    public class CColorInProduct : CBaseObject
    {

        public CColorInProduct()
        {
        ...
        public string Value
        {
            get
            {
                if (m_arrNewVal.ContainsKey("value"))
                    return m_arrNewVal["value"].StrVal;
                else
                    return "";
            }
            set
            {
                if (m_arrNewVal.ContainsKey("value"))
                    m_arrNewVal["value"].StrVal = value;
                else
                {
                    CValue val = new CValue();
                    val.StrVal = value;
                    m_arrNewVal.Add("value", val);
                }
            }
        }
    }
